...
class KFoldLoop(Loop):
    ...
    def on_advance_start(self, *args, **kwargs) -> None:
        """Used to call `setup_fold_index` from the `BirdieDataModule` instance."""
        print(f"STARTING FOLD {self.current_fold}")
        # Again, lets go easy with types.
        # assert isinstance(self.trainer.datamodule, BaseKFoldDataModule)
    ...
    def advance(self, *args, **kwargs) -> None:
        ...
        # Not sure if I need these or not - I don't want to test,
        # just train and validate.
    ...
    # Also skipping this for now, It seems to only be needed if including
    # a test group in the data
